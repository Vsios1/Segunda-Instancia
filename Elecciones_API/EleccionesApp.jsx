...
export default function App() {
  ...
  useEffect(() => {
    // Simula fetch a la API: reemplaza con fetch("http://localhost:5000/api/candidatos")
    setTimeout(() => {
    ...
    <>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12, color: "var(--muted)" }}>
          🔌 Para conectar la API real: reemplaza <code style={{ color: "var(--gold)", background: "var(--surface2)", padding: "1px 6px", borderRadius: 4 }}>CANDIDATOS_MOCK</code> con{" "}
          <code style={{ color: "var(--gold)", background: "var(--surface2)", padding: "1px 6px", borderRadius: 4 }}>fetch("http://localhost:5000/api/candidatos")</code>
        </p>
      </div>
    </>
  );
